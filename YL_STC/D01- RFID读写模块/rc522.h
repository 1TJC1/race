...
/***********************RC522 函数宏定义**********************/
#define          RC522_CS_Enable()         spi_cs=0
#define          RC522_CS_Disable()        spi_cs=1
 
#define          RC522_Reset_Enable()      spi_rst=0
#define          RC522_Reset_Disable()     spi_rst=1
 
#define          RC522_SCK_0()             spi_ck=0
#define          RC522_SCK_1()             spi_ck=1
 
#define          RC522_MOSI_0()            spi_mosi=0
#define          RC522_MOSI_1()            spi_mosi=1
